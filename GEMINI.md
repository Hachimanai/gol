...
- **Focus** : Vérifier le respect de la Clean Architecture et des règles de dépendance. S'assurer que la gestion des erreurs est explicite et "wrappée". Valider que les tests couvrent les cas limites. Signaler tout pattern non idiomatique.
...
- [x] **Raccourcis Clavier** : Implémenter des contrôles rapides (Play/Pause, Reset, Next Step).
